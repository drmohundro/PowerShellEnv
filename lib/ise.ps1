...
function Insert-Text {
    ...
    $currentFile = $psIse.CurrentOpenedRunspace.OpenedFiles | Where-Object { $_.FullPath -eq $currentFilePath }
...
[void]$psISE.CurrentPowerShellTab.AddOnsMenu.Submenus.Add("C_lear", {Clear-Host}, "Ctrl+L")
